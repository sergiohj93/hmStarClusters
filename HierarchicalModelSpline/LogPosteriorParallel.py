...
class LogPosteriorModule(object):
    ...
    def computeLikelihood(self, ctx):
        ...
        kcoefs =[np.array([knots,np.append(coefp[0],[0]*(self.degspl+1)),self.degspl]),
                 np.array([knots,np.append(coefp[1],[0]*(self.degspl+1)),self.degspl]),
                 np.array([knots,np.append(coefp[2],[0]*(self.degspl+1)),self.degspl]),
                 np.array([knots,np.append(coefp[3],[0]*(self.degspl+1)),self.degspl])]
        ###############################################################################################################
        ...
        evals =  np.vstack([self.delcol,
                            splev(self.delcol,kcoefs[0]),
                            splev(self.delcol,kcoefs[1]),
                            splev(self.delcol,kcoefs[2]),
                            splev(self.delcol,kcoefs[3])]).T
        ...
        lpsi =  map(partial(logLikeIndependentInc,
                ...
                coefs=kcoefs,phot_cov=phot_cov,alpha=alpha,
                stp=self.stp,rg_color=self.rg_color,
                evals=evals),self.obs_i)
